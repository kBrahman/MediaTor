...
public final class UXStats {
    ...
    private static final z.zer.tor.media.util.Logger LOG = z.zer.tor.media.util.Logger.getLogger(UXStats.class);
    private static final int HTTP_TIMEOUT = 4000;

    private final z.zer.tor.media.util.http.HttpClient httpClient;
