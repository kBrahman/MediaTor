...
public final class AudioPlayerActivity extends AbstractActivity implements ServiceConnection, OnSeekBarChangeListener, DeleteDialog.DeleteDialogCallback, ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    public boolean onPrepareOptionsMenu(final Menu menu) {
        ...
        if (favoriteMenuItem != null) {
            favoriteMenuItem.setIcon(MusicUtils.isFavorite() ? R.drawable.ic_action_favorite_selected : R.drawable.ic_action_favorite);
        }
        return true;
    }
    ...
    public boolean onOptionsItemSelected(final MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_player_audio_player_add_to_playlist:
                AddToPlaylistMenuAction menuAction = new AddToPlaylistMenuAction(this, new long[]{MusicUtils.getCurrentAudioId()});
                menuAction.onClick();
            default:
                break;
        }
    ...
    private static void shareTrackScreenshotTask(AudioPlayerActivity activity) {
        ...
        final String shareMessage = (artistName != null) ? activity.getString(R.string.now_listening_to, trackName, artistName) : activity.getString(R.string.now_listening_to_no_artist_available, trackName);
    ...
    private final OnClickListener mOpenAlbumProfile = v -> {
        ...
        try {
            NavUtils.openAlbumProfile(AudioPlayerActivity.this, MusicUtils.getAlbumName(), MusicUtils.getArtistName(), albumId, MusicUtils.getSongListForAlbum(AudioPlayerActivity.this, albumId));
        } catch (Throwable ignored) {
        ...
        public void handleMessage(final Message msg) {
            ...
            switch (msg.what) {
                case REFRESH_TIME:
                    ...
                    // the UI.
                    boolean blockingRefresh = (SystemClock.elapsedRealtime() - audioPlayerActivity.lastProgressBarTouched) < 500;
