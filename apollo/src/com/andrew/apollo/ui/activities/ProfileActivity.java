...
public final class ProfileActivity extends BaseActivity implements OnPageChangeListener, Listener {
    ...
    public boolean onCreateOptionsMenu(final Menu menu) {
        ...
        // Add to playlist
        if (isArtist() || isAlbum()) {
            final SubMenu subMenu = menu.addSubMenu(TabFragmentOrder.ALBUMS_POSITION, FragmentMenuItems.ADD_TO_PLAYLIST, Menu.NONE, R.string.add_to_playlist);
    ...
    public void onPageScrolled(final int position, final float positionOffset, final int positionOffsetPixels) {
        ...
        final int scrollToX = (int) ((position + positionOffset) * mTabCarousel.getAllowedHorizontalScrollLength());
