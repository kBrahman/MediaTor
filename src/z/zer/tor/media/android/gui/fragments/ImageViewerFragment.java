...
import z.zer.tor.media.android.gui.adapters.menu.DeleteSingleFileMenuAction;
...
import z.zer.tor.media.android.gui.views.TouchImageView;
import z.zer.tor.media.android.util.ImageLoader;
import z.zer.tor.media.android.util.ImageLoader.Callback;
...
public final class ImageViewerFragment extends AbstractFragment {
    ...
    protected void initComponents(View v, Bundle savedInstanceState) {
        ...
        containerLayout = v.findViewById(R.id.fragment_image_viewer_container_layout);
