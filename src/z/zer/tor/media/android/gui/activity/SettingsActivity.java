...
import z.zer.tor.media.android.gui.fragments.preference.ApplicationFragment;
...
public final class SettingsActivity extends AbstractActivity implements PreferenceFragment.OnPreferenceStartFragmentCallback {
     ...
     */
    public static final String EXTRA_SHOW_FRAGMENT = PreferenceActivity.EXTRA_SHOW_FRAGMENT;
     ...
     * of the activity.
     */
    public static final String EXTRA_SHOW_FRAGMENT_ARGUMENTS = PreferenceActivity.EXTRA_SHOW_FRAGMENT_ARGUMENTS;
     ...
     * that fragment.
     */
    public static final String EXTRA_SHOW_FRAGMENT_TITLE = PreferenceActivity.EXTRA_SHOW_FRAGMENT_TITLE;
    ...
    private void startPreferencePanel(String fragmentClass, Bundle args, CharSequence title, Fragment resultTo, int resultRequestCode) {
        if (singlePane) {
    ...
    private void startWithFragment(String fragmentName, Bundle args, CharSequence title, Fragment resultTo, int resultRequestCode) {
