...
import static zig.zak.media.tor.search.youtube.jd.JavaFunctions.escape;
import static zig.zak.media.tor.search.youtube.jd.JavaFunctions.isalpha;
import static zig.zak.media.tor.search.youtube.jd.JavaFunctions.isdigit;
import static zig.zak.media.tor.search.youtube.jd.JavaFunctions.join;
import static zig.zak.media.tor.search.youtube.jd.JavaFunctions.json_loads;
import static zig.zak.media.tor.search.youtube.jd.JavaFunctions.len;
import static zig.zak.media.tor.search.youtube.jd.JavaFunctions.list;
import static zig.zak.media.tor.search.youtube.jd.JavaFunctions.mscpy;
import static zig.zak.media.tor.search.youtube.jd.JavaFunctions.reverse;
import static zig.zak.media.tor.search.youtube.jd.JavaFunctions.slice;
import static zig.zak.media.tor.search.youtube.jd.JavaFunctions.remove_quotes;
...
import zig.zak.media.tor.regex.Matcher;
import zig.zak.media.tor.regex.Pattern;
