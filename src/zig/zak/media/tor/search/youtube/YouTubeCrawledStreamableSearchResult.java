...
package zig.zak.media.tor.search.youtube;

import zig.zak.media.tor.search.StreamableSearchResult;
import zig.zak.media.tor.search.youtube.YouTubeExtractor.LinkInfo;

import static zig.zak.media.tor.search.youtube.YouTubeUtils.buildDownloadUrl;
import static zig.zak.media.tor.search.youtube.YouTubeUtils.isDash;
