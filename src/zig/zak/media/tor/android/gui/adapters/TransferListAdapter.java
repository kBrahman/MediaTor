...
import zig.zak.media.tor.android.gui.adapters.menu.StopSeedingAction;
import zig.zak.media.tor.android.gui.adapters.menu.TransferDetailsMenuAction;
import zig.zak.media.tor.android.gui.services.Engine;
import zig.zak.media.tor.android.gui.transfers.UIBittorrentDownload;
import zig.zak.media.tor.android.gui.util.TransferStateStrings;
...
import zig.zak.media.tor.bittorrent.BTDownloadItem;
import zig.zak.media.tor.bittorrent.BTEngine;
import zig.zak.media.tor.bittorrent.PaymentOptions;
import zig.zak.media.tor.search.WebSearchPerformer;
